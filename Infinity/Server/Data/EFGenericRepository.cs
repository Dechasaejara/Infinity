...
{
    public class EFGenericRepository<TEntity, TDataContext> : IGenericRepository<TEntity> where TEntity : class where TDataContext : DbContext
    {
        protected readonly TDataContext context;
        internal DbSet<TEntity> dbSet;
        public EFGenericRepository(TDataContext dataContext)
        {
            context = dataContext;
